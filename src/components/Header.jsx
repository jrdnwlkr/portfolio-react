    ...
    return (
        <div className='relative bg-gray-900 w-full h-[80px] flex justify-between items-center px-4'>
          ...
          className={`text-sm font-bold tracking-widest py-2 rounded-md ${
            currentPage === 'About' ? 'bg-lime-500 text-lime-950' : 'text-gray-500 hover:text-gray-950 hover:bg-gray-700'
          } mr-2`}
        >
          ABOUT
        </li>
        <li
          ...
          className={`text-sm font-bold tracking-widest py-2 rounded-md ${
            currentPage === 'Project' ? 'bg-lime-500 text-lime-950' : 'text-gray-500 hover:text-gray-950 hover:bg-gray-700'
          } mr-2`}
        >
          WORK
        </li>
        <li
          ...
          className={`text-sm font-bold tracking-widest py-2 rounded-md ${
            currentPage === 'Contact' ? 'bg-lime-500 text-lime-950' : 'text-gray-500 hover:text-gray-950 hover:bg-gray-700'
          }`}
        >
          CONTACT
        </li>
